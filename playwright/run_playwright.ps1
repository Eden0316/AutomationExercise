...
$CliLog = Join-Path $LogDir ("playwright_cli_{0}.log" -f $Timestamp)

Write-Host "==============================================="
Write-Host " Playwright UI Test Runner"
...
npx playwright test 2>&1 | ForEach-Object {
    $line = $_.ToString()
...
$SavedReportDir = Join-Path $ReportRoot ("playwright_report_{0}" -f $Timestamp)
...
Write-Host ""
Write-Host "==============================================="
Write-Host " Playwright finished. ExitCode: $ExitCode"
